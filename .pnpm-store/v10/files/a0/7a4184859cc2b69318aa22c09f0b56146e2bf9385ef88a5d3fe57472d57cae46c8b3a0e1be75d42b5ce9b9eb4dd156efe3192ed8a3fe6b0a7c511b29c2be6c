 ...
 */
export declare function createAsyncStorage(databaseName: string): AsyncStorage;
/**
 ...
 */
export declare function getLegacyStorage(): AsyncStorage;
//# sourceMappingURL=createAsyncStorage.native.d.ts.map